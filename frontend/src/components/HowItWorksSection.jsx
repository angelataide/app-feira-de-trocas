        ...
        <HowItWorksSectionWrapper>
            ...
            <StepsContainer>
                <StepCard>
                    ...
                    <StepDescription>
                        Comece criando seu perfil e listando os itens que você
                        gostaria de trocar.
                    </StepDescription>
                </StepCard>
                <StepCard>
                    ...
                    <StepDescription>
                        Navegue por uma variedade de itens disponíveis na sua
                        comunidade.
                    </StepDescription>
                </StepCard>
                <StepCard>
                    ...
                    <StepDescription>
                        Envie propostas de troca para os itens que te
                        interessam.
                    </StepDescription>
                </StepCard>
                <StepCard>
                    ...
                    <StepDescription>
                        Combine os detalhes da troca diretamente com o outro
                        usuário e finalize o processo de forma segura.
                    </StepDescription>
                </StepCard>
            </StepsContainer>
        </HowItWorksSectionWrapper>
